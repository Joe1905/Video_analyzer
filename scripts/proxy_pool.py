...
from proxy import repository as proxy_repository
from proxy.nodes import _clean_text, parse_static_proxy_uri, parse_vless_uri, parse_vmess_uri
...
def init_db(conn: sqlite3.Connection) -> None:
    # Remove this entry point once proxy callers own their repository inputs.
    proxy_repository.init_db(
        conn,
        clean_port_scope=_clean_port_scope,
        port_range=_port_range,
        now_iso=now_iso,
        system_proxy_dialer=SYSTEM_PROXY_DIALER,
